...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   include "db-connection.php";
    ...
    $stmt = $conn->prepare("INSERT INTO user (nom, prenom, adress, nomPere, nomMere, telephone_personnel, telephone_waliy, picture) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssssss", $nom, $prenom, $adress, $nomPere, $nomMere, $telephone_personnel, $telephone_waliy, $picture);
